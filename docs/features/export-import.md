...
- **Import** (from Create User) reads that file, resolves those names to the **target
  org's** IDs, and pre-fills the Create User form. You set a new email/username, review, and
  submit — creating the user through the normal [create flow](create-user.md).
